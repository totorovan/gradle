...
class VisualStudioSolutionFile extends AbstractPersistableConfigurationObject {
    ...
    private Map<File, String> projects = Maps.newHashMap()
    private Map<File, Set<String>> projectConfigurations = Maps.newHashMap()
    private baseText
...
Global
	GlobalSection(SolutionConfigurationPlatforms) = preSolution"""
        Set<String> configurationNames = projectConfigurations.values().flatten() as Set
	...
	GlobalSection(ProjectConfigurationPlatforms) = postSolution"""
        projects.each { File projectFile, String projectName ->
            projectConfigurations[projectFile].each { String configurationName ->
